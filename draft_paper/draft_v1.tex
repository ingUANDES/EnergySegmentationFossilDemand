...
%\smallskip
%A capacity investment model is characterized by
%\small
%$$\left(\left((a_i,b_i),I_i, TC_i(t,\omega),TCR_i(t,\omega), CF_i, \bar{Q}_i, RP_i,\varepsilon_i\right)_{i\in\{1,...N\}},\tau,D, (Pr(\omega))_{\omega\in\Omega}\right)\in\Xi^N\times\mathbb{R}_+\times\left(\mathbb{R}_+\times\mathbb{R}_+^{T\times\Omega}\right)\times\Delta.$$
%\normalsize
