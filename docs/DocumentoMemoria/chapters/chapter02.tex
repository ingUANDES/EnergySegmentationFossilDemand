...
\begin{enumerate}
  ...
  \item Agregar las restricciones: hay que agregar las restricciones del modelo. La como se menc de las variables se pueden agregar en la misma definición de las variables o como restricción,
...
\begin{enumerate}
   \item Definir las variables: es necesario definir las variables dependiendo de su como se menc. Se emplea la siguiente nomenclatura,
...
\begin{enumerate}
   ...
   \item Definir las variables: es necesario definir las variables según su como se menc, con la siguiente nomenclatura,
