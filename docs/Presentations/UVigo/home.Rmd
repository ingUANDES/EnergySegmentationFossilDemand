...
where $P\in[0,1]$ is a performance metric, $c$ an associated marginal cost and $d$ the performance level wiht public information.

We drop the chance constraint approach, by using

- $\min_{(\theta,P)\in[0,(1+\epsilon)CAP]\times[0,1]}-\theta\pi^aP+c(P-d)^2$ profit oriented
